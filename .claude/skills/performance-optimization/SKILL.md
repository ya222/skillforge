...
metadata:
  skillforge:
    ...
    attribution: Adapted from addyosmani/agent-skills (MIT), skills/performance-optimization at df1edb2e0548.
---
...
- [ ] `make test` still passes (optimization didn't break behavior)
