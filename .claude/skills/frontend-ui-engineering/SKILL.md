...
metadata:
  skillforge:
    version: 1.0.0
    source: ./skills/frontend-ui-engineering
    attribution: Adapted from addyosmani/agent-skills (MIT), skills/frontend-ui-engineering at df1edb2e0548.
---
...
Match the project's existing design tokens. When a value is not in the system, ask before inventing one.
