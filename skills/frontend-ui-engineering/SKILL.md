...
metadata:
  skillforge:
    ...
    globs:
      ...
      - "**/*.scss"
    attribution: >-
      Adapted from addyosmani/agent-skills (MIT), skills/frontend-ui-engineering
      at df1edb2e0548.
    params:
      framework:
        type: enum
        values: [react, vue, svelte]
        description: UI framework this project uses.
        default: react
      design_system:
        type: string
        description: What the UI must match, named the way the team names it.
        default: the project's existing design tokens
      wcag_level:
        type: enum
        values: [A, AA, AAA]
        description: WCAG conformance level to hold the UI to.
        default: AA
---
...
<!-- skillforge:block id=component-patterns when='params.framework == "react"' -->
### Component Patterns
...
<!-- skillforge:block id=state-management -->
## State Management
...
Match {{ params.design_system }}. When a value is not in the system, ask before inventing one.
...
## Accessibility (WCAG 2.1 {{ params.wcag_level }})
...
<!-- skillforge:block id=responsive-design -->
## Responsive Design
...
<!-- skillforge:block id=loading-and-transitions -->
...
<!-- skillforge:point id=before-red-flags -->
